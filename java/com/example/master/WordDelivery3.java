...
public class WordDelivery3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_delivery3);
...
//                Toast.makeText(WordDelivery1.this,"balik",Toast.LENGTH_SHORT).show();
        ...
        final MediaPlayer mediaPlayer = MediaPlayer.create(this,R.raw.killer);
    ...
    public void correct(){
        ...
        Intent intent = new Intent(this, WordDelivery4.class);
