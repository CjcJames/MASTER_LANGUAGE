...
public class WordDelivery5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_delivery5);
...
//                Toast.makeText(WordDelivery1.this,"balik",Toast.LENGTH_SHORT).show();
        ...
        final MediaPlayer mediaPlayer = MediaPlayer.create(this,R.raw.starmp3);
    ...
    public void correct(){
        ...
        Intent intent = new Intent(this, ResultDelivery.class);
